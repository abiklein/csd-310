...
cursor.execute("SELECT equipment_name, supply_order_date, supply_order_id, supply_order_quantity FROM supplyorder INNER "
               "JOIN equipment ON supplyorder.equipment_id=equipment.equipment_id WHERE YEAR(supply_order_date) <= 2017")

supplyorder = cursor.fetchall()

for supplyorder in supplyorder:
    print("Equipment Name: {}\nDate Ordered: {}\nInvoice Number: {}\nQuantity Ordered: {}\n".format(supplyorder[0],
           supplyorder[1], supplyorder[2], supplyorder[3]))