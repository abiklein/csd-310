...
INSERT INTO equipment (equipment_name, equipment_rent_price, equipment_buy_price, equipment_quantity)
VALUES('Tents', 20, 100, 2);

INSERT INTO equipment (equipment_name, equipment_rent_price, equipment_buy_price, equipment_quantity)
VALUES('sleeping bags', 15, 75, 5);

INSERT INTO equipment (equipment_name, equipment_rent_price, equipment_buy_price, equipment_quantity)
VALUES('headlamps', 10, 40, 5);

INSERT INTO equipment (equipment_name, equipment_rent_price, equipment_buy_price, equipment_quantity)
VALUES('Camp chairs', 5, 25, 5);

INSERT INTO equipment (equipment_name, equipment_rent_price, equipment_buy_price, equipment_quantity)
VALUES('Lanterns', 5, 25, 10);

INSERT INTO equipment (equipment_name, equipment_rent_price, equipment_buy_price, equipment_quantity)
VALUES('Boots', 20, 60, 5);
...
VALUES((SELECT customer_id FROM customer WHERE customer_id = '1'), (SELECT equipment_id FROM equpiment WHERE equipment_id = '6'), 
'1', '09/16/2020 ', 'RENT');

INSERT INTO customerOrder(customer_id, equipment_id, customer_equipment_quantity, customer_order_date, rented_or_bought) 
VALUES((SELECT customer_id FROM customer WHERE customer_id = '2'), (SELECT equipment_id FROM equpiment WHERE equipment_id = '5'), 
'1', '5/15/2018 ', 'BUY');

INSERT INTO customerOrder(customer_id, equipment_id, customer_equipment_quantity, customer_order_date, rented_or_bought) 
VALUES((SELECT customer_id FROM customer WHERE customer_id = '3'), (SELECT equipment_id FROM equpiment WHERE equipment_id = '4'), 
'2', '6/14/2022', 'RENT');

INSERT INTO customerOrder(customer_id, equipment_id, customer_equipment_quantity, customer_order_date, rented_or_bought) 
VALUES((SELECT customer_id FROM customer WHERE customer_id = '4'), (SELECT equipment_id FROM equpiment WHERE equipment_id = '3'), 
'2 ', '2/13/2017', 'BUY');

INSERT INTO customerOrder(customer_id, equipment_id, customer_equipment_quantity, customer_order_date, rented_or_bought) 
VALUES((SELECT customer_id FROM customer WHERE customer_id = '5'), (SELECT equipment_id FROM equpiment WHERE equipment_id = '2'), 
'1 ', '4/27/2021', 'RENT');

INSERT INTO customerOrder(customer_id, equipment_id, customer_equipment_quantity, customer_order_date, rented_or_bought) 
VALUES((SELECT customer_id FROM customer WHERE customer_id = '6'), (SELECT equipment_id FROM equpiment WHERE equipment_id = '1'), 
'5', '11/15/2015', 'BUY');

-- insert into supplyOrder table
INSERT INTO supplyOrder (equipment_id, equipment_unit_price, equipment_quantity, supply_order_date, supplier_id)
VALUES ((SELECT equipment_id FROM equipment WHERE equipment_id = '1'), '10', '4', '02/19/2022', 
(SELECT supplier_id FROM supplier WHERE supplier_id = '3 '));

INSERT INTO supplyOrder (equipment_id, equipment_unit_price, equipment_quantity, supply_order_date, supplier_id)
VALUES ((SELECT equipment_id FROM equipment WHERE equipment_id = '2'), '8', '6', '07/07/2015', 
(SELECT supplier_id FROM supplier WHERE supplier_id = '5'));

INSERT INTO supplyOrder (equipment_id, equipment_unit_price, equipment_quantity, supply_order_date, supplier_id)
VALUES ((SELECT equipment_id FROM equipment WHERE equipment_id = '3'), '3', '9', '04/12/2017', 
(SELECT supplier_id FROM supplier WHERE supplier_id = '2'));

INSERT INTO supplyOrder (equipment_id, equipment_unit_price, equipment_quantity, supply_order_date, supplier_id)
VALUES ((SELECT equipment_id FROM equipment WHERE equipment_id = '4'), '2', '1', '12/03/2021', 
(SELECT supplier_id FROM supplier WHERE supplier_id = '1'));

INSERT INTO supplyOrder (equipment_id, equipment_unit_price, equipment_quantity, supply_order_date, supplier_id)
VALUES ((SELECT equipment_id FROM equipment WHERE equipment_id = '5'), '2', '15', '04/15/2016', 
(SELECT supplier_id FROM supplier WHERE supplier_id = '6'));

INSERT INTO supplyOrder (equipment_id, equipment_unit_price, equipment_quantity, supply_order_date, supplier_id)
VALUES ((SELECT equipment_id FROM equipment WHERE equipment_id = '6'), '13', '25', '10/31/2020', 
